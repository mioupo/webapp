...
public class DateUtils {
	...
	public static List<String> getFiveWorkDayFromTody() throws ParseException{
		List<String> resList = new ArrayList<String>();
		String before = DateUtils.getCurrentDateAlter(-7);
		Date startDate = dateFormat.parse(before);
		Date today = dateFormat.parse(DateUtils.currentDate());
	...
	public static List<String> getFiveWorkDayStrFromTody() throws ParseException{
		List<String> resList = new ArrayList<String>();
		String before = DateUtils.getCurrentDateAlter(-7);
		Date startDate = dateFormat.parse(before);
		Date today = dateFormat.parse(DateUtils.currentDate());
